...
public class MiniPgTest {
    ...
    private Connection getConnection() {
        ...
        // String url =
        String url = "jdbc:postgresql://192.168.2.133:9998/postgres?user=postgres&password=080419";
...
//        String command = "-- pg_remove_sync_slave(server7)";
          String command = "-- pg_basebackup(192.168.2.134)";
//        String command = "-- pg_rewind(192.168.2.134)";
//        String command  = "-- pg_start";
