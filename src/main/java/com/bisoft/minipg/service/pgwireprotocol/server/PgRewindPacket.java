...
public class PgRewindPacket extends AbstractWireProtocolPacket {
    ...
    String REGEX_REWIND = ".*" + PG_REWIND + LEFT_PARENTHESES + MASTER_IP + RIGHT_PARENTHESES + ".*";
    ...
    public byte[] response() {
        // basic pg_rewind usage for Postgres is as follow:
        ...
        // and we assume that we get these two params: host=192.168.2.90 port=5432 user=postgres
